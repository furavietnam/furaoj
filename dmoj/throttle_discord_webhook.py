...
def new_webhook():
    cache.add('error_discord_webhook_throttle', 0, settings.FURAOJ_DISCORD_WEBHOOK_THROTTLING[1])
...
class ThrottledDiscordWebhookHandler(logging.Handler):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Send at most (FURAOJ_DISCORD_WEBHOOK_THROTTLING[0]) message in
        # (FURAOJ_DISCORD_WEBHOOK_THROTTLING[1]) seconds
        self.throttle = settings.FURAOJ_DISCORD_WEBHOOK_THROTTLING[0]
