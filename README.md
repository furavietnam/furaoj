# FuraOJ: Fura Online Judge [![Build Status](https://github.com/furavietnam/furaoj/workflows/build/badge.svg)](https://github.com/furavietnam/furaoj/actions/) [![AGPL License](https://img.shields.io/badge/license-AGPLv3.0-blue.svg)](http://www.gnu.org/licenses/agpl-3.0) [![Discord link](https://img.shields.io/discord/1543889697502138470?color=%237289DA&label=Discord&logo=Discord)](https://discord.gg/rSryQhHvX6)

As a fork of [DMOJ](https://github.com/DMOJ/online-judge), FuraOJ serves as [Fura](https://team.fura.io.vn/)'s official online judge and hosts its programming contests.

See it live at [oj.fura.io.vn](https://oj.fura.io.vn/)!
...
Refer to the install documentation [here](https://docs.oj.fura.io.vn/). Almost all installation steps remain the same as the docs, but there are several minor differences, including cloning this repo instead of DMOJ's repo.
...
- Regarding disabling full-text search, please read [this issue](https://github.com/furavietnam/furaoj/issues/4) for more information.
...
If you find any bug, please feel free to contact us via Discord [![Discord Chat](https://img.shields.io/discord/1543889697502138470?color=%237289DA&label=Discord&logo=Discord)](https://discord.gg/rSryQhHvX6) or open an issue.
