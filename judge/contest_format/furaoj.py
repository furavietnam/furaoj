...
@register_contest_format('furaoj')
class FuraOJContestFormat(DefaultContestFormat):
    name = gettext_lazy('FuraOJ')
    ...
    def validate(cls, config):
        ...
        if not isinstance(config, dict):
            raise ValidationError('FuraOJ-styled contest expects no config or dict as config')
