...
class OrganizationQuotaTestCase(CommonDataMixin, TestCase):
    ...
    def test_get_max_problems_default_no_quotas(self):
        ...
        self.assertEqual(
            ...
            settings.FURAOJ_ORGANIZATION_DEFAULT_MAX_PROBLEMS,
        )

    @override_settings(FURAOJ_ORGANIZATION_DEFAULT_MAX_PROBLEMS=1000)
    ...
    def test_get_max_storage_default_no_quotas(self):
        ...
        self.assertEqual(
            ...
            settings.FURAOJ_ORGANIZATION_DEFAULT_MAX_STORAGE,
        )

    @override_settings(FURAOJ_ORGANIZATION_DEFAULT_MAX_STORAGE=5 * 1024 * 1024 * 1024)
    ...
    @override_settings(FURAOJ_ORGANIZATION_DEFAULT_MAX_PROBLEMS=2)
    ...
    @override_settings(FURAOJ_ORGANIZATION_DEFAULT_MAX_PROBLEMS=1)
    ...
    def test_can_upload_data_at_limit(self):
        ...
        ProblemData.objects.filter(problem=problem).update(
            zipfile_size=settings.FURAOJ_ORGANIZATION_DEFAULT_MAX_STORAGE,
        )
